  ...
  const experiences = [
    {
      ...
      description: [
        "Integrated REST APIs for listings, user profiles, authentication, bookings, and payments using Axios and React Query.",
        "Developed a dynamic property listing interface with server-side pagination, sorting, and filtering by price, location, amenities, and availability.",
        "Built a secure OTP-based authentication system, including login, signup, and password recovery flows using React hooks and context.",
        "Built a modular component library (buttons, cards, forms, filters, carousels), enabling reusability, reducing development time by 35% and enhanced optimization.",
        "Optimized bundle size using code-splitting, lazy loading, and React Suspense, reducing initial load time by 40%.",
        "Implemented client-side caching mechanisms using React Query improving page responsiveness and reducing redundant API calls.",
      ],
